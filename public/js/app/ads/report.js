...
(function($) {
    ...
    $(function () {
        // Define vars
        var mJWpid = $.mainJqxWidgets;
        var phpData = mJWpid.$layout.data('php') || {};
        //
        ...
        mJWpid.prepareWindowCRUD($jqxWindow);
        ...
        function handleActions(evt) {
            ...
            if ('show' === evt.action) {
                if (evt.row) {
                    ...
                    mJWpid.helper.fillFormData($targetForm, evt.row);
                    // Show form
         ...
         *
         */
        mJWpid.$layout.on('actionclick', function (jEvt, evt) {
         ...
         */
        mJWpid.$toolbar.on('initToolbarItems', function(evt, tbItems) {
            mJWpid.removeToolbarItems(['create', 'update', 'delete']);
         ...
         */
        mJWpid.$grid.on('initMenuItems', function(evt, mnuItems) {
            mJWpid.removeMenuItems(['create', 'update', 'delete']);
            $.each(mJWpid.menuData.source, function(idx, srcItem) {
