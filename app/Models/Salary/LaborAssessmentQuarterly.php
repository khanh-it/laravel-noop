...
class LaborAssessmentQuarterly extends Models\Salary
{
    /**
    ...
    protected static function boot()
    {
        ...
        static::addGlobalScope('type', function (Builder $builder) {
            $builder->where(static::columnName('type'), static::TYPE_90);
        });
    }
    ...
    public function __construct()
    {
        ...
        // Self init
        $this->typeLaborAssessmentQuarterly();
        //
        return $return;
    }
    ...
    {
        return $this->hasMany(LaborAssessmentQuarterlyDetail::class, LaborAssessmentQuarterlyDetail::columnName('salary_id'));
    }
