 ...
 * @class Fixed
 */
class Fixed extends Models\Salary
{
    /**
    ...
    protected static function boot()
    {
        ...
        static::addGlobalScope('type', function (Builder $builder) {
            $builder->where(static::columnName('type'), static::TYPE_80);
        });
    }
    ...
    {
        return $this->hasMany(FixedDetail::class, FixedDetail::columnName('salary_id'));
    }
