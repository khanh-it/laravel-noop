...
/**
 * @class PreproductivityQuarterlyDetail
 */
class PreproductivityQuarterlyDetail extends Models\SalaryDetail
{
    /**
    ...
    /**
     * Get Salary\Preproductivity.
     * @return Preproductivity|null
     */
    public function salary()
    {
        return $this->belongsTo(PreproductivityQuarterly::class, $this->columnName('salary_id'));
    }
    ...
    public function assignSalaryAndTimeSheetInfo(Models\SalaryConfig $salaryConfig, Models\Account $account, array $salaryTSInfo, array $options = [])
    {
        ...
        $slrdInfo = [
            ($colPrefix . ($col = 'salary_additional_subtotal')) => ($salaryAdditionalSubtotal
                = (
                    $this->colVal('salary_quarterly_productivity')
     ...
     * @return void
     */
    public function jqxFetchRecordList(PreproductivityQuarterly $salaryModel, array $data, &$qB = null, &$totalRowsQB = null)
    {
        // Define vars
        // +++
        //Roles
