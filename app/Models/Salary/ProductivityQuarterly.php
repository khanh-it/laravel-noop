...
/**
 * @class ProductivityQuarterly
 */
class ProductivityQuarterly extends Models\Salary
{
    /**
    ...
    protected static function boot()
    {
        ...
        static::addGlobalScope('type', function (Builder $builder) {
            $builder->where(static::columnName('type'), static::TYPE_60);
        });
    }
    ...
    public function __construct()
    {
        ...
        // Self init
        $this->typeProductivityQuarterly();
        //
        return $return;
    }
    ...
    {
        return $this->hasMany(ProductivityQuarterlyDetail::class, ProductivityQuarterlyDetail::columnName('salary_id'));
    }
